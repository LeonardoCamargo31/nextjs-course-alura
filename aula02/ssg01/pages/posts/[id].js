...
/*
  Se tem rotas dinamicas e usa getStaticProps ela precisa definir uma
  lista de caminhos a serem gerados estaticamente
  Essas funções getStaticPaths e getStaticProps só executam no build
*/
export async function getStaticPaths() {
  ...
  return {
    paths: paths,
    fallback: false // true, false ou "blocking", nesse caso nós lidamos com o 404 ou not found
  };
}

/*
  Quando rodar o comando de build, next vai baixar esse conteudo
  até que ocorra um novo build
*/
